...
void UKF::ProcessMeasurement(MeasurementPackage meas_package) {
  if (!is_initialized_ ) {
    ...
    if(meas_package.raw_measurements_[0]==0 || meas_package.raw_measurements_[1]==0){
      cout << "Invalid entries at initialization. Skipping line" << endl;
      return;
    }
    ...
    if (meas_package.sensor_type_ == MeasurementPackage::RADAR && use_radar_) {
      ...
      */
      ...
      float dp = meas_package.raw_measurements_[2] ;
      ...
      Initialize state.
      */
      x_ << meas_package.raw_measurements_[0],meas_package.raw_measurements_[1], 0.1, 0.1, 0.01;
